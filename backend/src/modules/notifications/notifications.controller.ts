import { Controller, Get, Put, Param, ParseIntPipe, Headers as HttpHeaders } from '@nestjs/common';
...
export class NotificationsController {
    ...
    @Put(':id/read')
    async markAsRead(@Param('id', ParseIntPipe) id: number, @HttpHeaders('x-user-id') userIdHeader: string) {
        const userId = userIdHeader ? parseInt(userIdHeader) : 1;
