...
import { NotificationFactory, NotificationType } from './factory/notification.factory';
...
export class NotificationsService implements OnModuleInit {
     ...
     */
    async send(userId: number, title: string, message: string, type: string = 'INFO', channels: NotificationType[] = ['DB']) {
        const errors: any[] = [];
